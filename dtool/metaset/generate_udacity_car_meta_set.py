...
try:
    os.makedirs('./data/kaggle/udacity2coco/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data/kaggle/udacity2coco"
# IMAGE_DIR = "./data/kaggle/udacity2coco/data/export/"
IMAGE_DIR = "./data/kaggle/udacity2coco/udacity_self_driving_car_kaggle/data/export/"
TARGET_DIR = "./data/kaggle/udacity2coco/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/udacity2coco_sample_img_250.json",'r') as load_f:
