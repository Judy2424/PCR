...
try:
    os.makedirs('./data/kaggle/self_driving2coco/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data/kaggle/self_driving2coco"
# IMAGE_DIR = "./data/kaggle/self_driving2coco/images"
# TARGET_DIR = "./data/kaggle/self_driving2coco/meta"
IMAGE_DIR = "./data/kaggle/self_driving2coco/self_driving_cars_kaggle/images"
TARGET_DIR = "./data/kaggle/self_driving2coco/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/self_driving2coco_sample_img_250.json",'r') as load_f:
