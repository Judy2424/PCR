...
try:
    os.makedirs('./data/kaggle/traffic2coco/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data/kaggle/traffic2coco"
# IMAGE_DIR = "./data/kaggle/traffic2coco/train/images"
IMAGE_DIR = "./data/kaggle/traffic2coco/traffic_kaggle/train/images"
TARGET_DIR = "./data/kaggle/traffic2coco/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/traffic2coco_sample_img_250.json",'r') as load_f:
