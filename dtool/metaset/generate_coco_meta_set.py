...
try:
    os.makedirs('./data/coco/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data/coco"
TARGET_DIR = "./data/coco/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/annotations/instances_val2017_sample_img_250.json",'r') as load_f:
...
for num in trange(num_meta_dataset):
    for img_path in list(car_image_id_dict.keys()):
        img_name = os.path.join(ROOT_DIR, "val2017", img_path)
