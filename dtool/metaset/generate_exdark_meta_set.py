...
try:
    os.makedirs('./data/exdark/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data/exdark"
IMAGE_DIR = "./data/exdark/exdark2coco/img"
TARGET_DIR = "./data/exdark/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/exdark2coco/ann/annotations_sample_img_250.json",'r') as load_f:
