...
try:
    os.makedirs('./data_inc_person/kitti/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./person_sample_250_images/kitti"
IMAGE_DIR = "./person_sample_250_images/kitti"
TARGET_DIR = "./data_inc_person/kitti/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/kitti_annotations_sample_img_250.json",'r') as load_f:
