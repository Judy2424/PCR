...
try:
    os.makedirs('./data_inc_person/self_driving/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./person_sample_250_images/self_driving"
IMAGE_DIR = "./person_sample_250_images/self_driving"
TARGET_DIR = "./data_inc_person/self_driving/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/selfdriving_annotations_sample_img_250.json",'r') as load_f:
