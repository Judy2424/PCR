...
try:
    os.makedirs('./data_inc_person/crowdhuman/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./person_sample_250_images/crowdhuman"
IMAGE_DIR = "./person_sample_250_images/crowdhuman"
TARGET_DIR = "./data_inc_person/crowdhuman/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/crowdhuman_annotations_sample_img_250.json",'r') as load_f:
