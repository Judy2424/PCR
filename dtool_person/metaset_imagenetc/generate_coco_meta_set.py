...
try:
    os.makedirs('./data_inc_person/coco/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./person_sample_250_images/coco"
IMAGE_DIR = "./person_sample_250_images/coco"
TARGET_DIR = "./data_inc_person/coco/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/coco_annotations_sample_img_250.json",'r') as load_f:
