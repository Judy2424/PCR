...
try:
    os.makedirs('./data_inc_person/caltech/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./person_sample_250_images/caltech"
IMAGE_DIR = "./person_sample_250_images/caltech"
TARGET_DIR = "./data_inc_person/caltech/meta"
num_meta_dataset = 50

with open(ROOT_DIR + "/caltech_annotations_sample_img_250.json",'r') as load_f:
